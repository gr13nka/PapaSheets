 ...
 *
 * Фото в листе — опознавательный знак, а не иллюстрация: разглядывают его, увеличив в Excel, а не
 * в общей таблице. Поэтому высота выбрана так, чтобы строку задавал текст, а не картинка: с трёх
 * строк «вида работ» (45pt) высоту диктует уже он. Прежние 90pt (M6) держали кадр читаемым прямо
 * в таблице, но растягивали журнал так, что терялся обзор, — обзор оказался важнее.
 *
 ...
 */
internal const val PHOTO_ROW_HEIGHT_PT = 36.0
